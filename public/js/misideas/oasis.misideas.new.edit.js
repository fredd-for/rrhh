 ...
 */
function cargaListaDeTiposDeNegocios(opcion,idExcepcion,tipoGenero,boleta){
    var sufijo = "New";
    if(opcion==2)sufijo = "Edit";
    var selected = "";
    $("#lstTiposDeNegocios"+sufijo).html("");
    $("#lstTiposDeNegocios"+sufijo).append("<option value=''>Seleccionar..</option>");
    $("#lstTiposDeNegocios"+sufijo).prop("disabled",true);
    var frecuencia = "";
    $.ajax({
        url: '/ideas/listnegocios/',
        type: "POST",
        datatype: 'json',
