...
/**
 * Función para la habilitación de los campos correspondientes en el formulario de registro de un nuevo perfil laboral.
 * @param idOrganigrama Identificador del organigrama.
 * @param idFinPartida Identificador del financiamiento por partida.
 */
function habilitarCamposParaNuevoRegistroDePerfilLaboral(idOrganigrama,idFinPartida){
    defineFechas();
}
/**
