...
$().ready(function () {
     ...
     */
    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('theme', 'oasis');
    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('enableAt', 0);
    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('disableAt', 1);
    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('disableAt', 2);
    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('disableAt', 3);
        ...
        $("#divGridFeriados").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    $("#addrowbutton").on('click', function () {
                        $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('enableAt', 1);
                        $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('disableAt', 2);
                        $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('disableAt', 3);
                        $('#divTabRelaboralesHorariosMarcaciones').jqxTabs({selectedItem: 1});
                        ...
                        if (selectedrowindex >= 0) {
                            ...
                            if (dataRecord != undefined) {
                                ...
                                if (dataRecord.estado >= 1) {
                                    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('enableAt', 0);
                                    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('disableAt', 1);
                                    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('enableAt', 2);
                                    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('disableAt', 3);
                                    $('#divTabRelaboralesHorariosMarcaciones').jqxTabs({selectedItem: 2});
                    ...
                    $("#calendarrowbutton").on('click', function () {
                        ...
                        $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('disableAt', 1);
                        $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('disableAt', 2);
                        $('#divTabRelaboralesHorariosMarcaciones').jqxTabs('enableAt', 3);
                        $('#divTabRelaboralesHorariosMarcaciones').jqxTabs({selectedItem: 3});
...
function OperaEvento(evento) {
    if ((evento.type == "keyup" || evento.type == "keydown") && evento.which == "27") {
         ...
         */
        $('#divTabRelaboralesHorariosMarcaciones').jqxTabs({selectedItem: 0});
    }
}
