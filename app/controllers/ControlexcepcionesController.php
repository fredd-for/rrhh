            ...
            if ($resul->count() > 0) {
                foreach ($resul as $v) {
                    $controlexcepciones[] = array(
                        ...
                        'controlexcepcion_fecha_reg'=>$v->controlexcepcion_fecha_reg != "" ? date("d-m-Y", strtotime($v->controlexcepcion_fecha_reg)) : "",
                        ...
                        'controlexcepcion_fecha_apr'=>$v->controlexcepcion_fecha_apr != "" ? date("d-m-Y", strtotime($v->controlexcepcion_fecha_apr)) : "",
                        ...
                        'controlexcepcion_fecha_mod'=>$v->controlexcepcion_fecha_mod != "" ? date("d-m-Y", strtotime($v->controlexcepcion_fecha_mod)) : "",
